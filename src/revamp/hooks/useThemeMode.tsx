...
import { getSafeTheme } from '../theme/safeTheme';
...
const useThemeMode: useThemeModeType = (
  initialThemeMode = LIGHT_THEME_MODE
) => {
  ...
  const theme = React.useMemo(() => getSafeTheme(themeMode), [themeMode]);
